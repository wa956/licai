...
//会员
class MemberController extends Rbac\My_Controller{
    //会员列表展示
    public function lists(){
        ...
        $p_info=Common::where("mem_status",0)->whereRaw($where)->paginate(5)->toArray();
        $p_info['prev_page_url']=$p_info['prev_page_url']."&datemin=$datemin&datemax=$datemax&content=$content";
        if($p_info['prev_page_url']=="&datemin=&datemax=&content="){
            $p_info['prev_page_url']="";
        }
        $p_info['next_page_url']=$p_info['next_page_url']."&datemin=$datemin&datemax=$datemax&content=$content";
        if($p_info['next_page_url']=="&datemin=&datemax=&content="){
            $p_info['next_page_url']="";
        }
