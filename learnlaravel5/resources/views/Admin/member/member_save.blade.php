...
<article class="page-container">
	<form action="member_save_success" method="post" class="form form-horizontal" id="form-member-add" target="_parent">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$data['telephone']}}" placeholder="" id="mobile" name="telephone">
			</div>
		</div>
		<div class="row cl">
