...
<div class="page-container">
    <form action="duadd" method="post" class="form form-horizontal" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="start_time" onClick="WdatePicker()"  id="datemin" class="input-text Wdate" style="width:180px;height:1.8em">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">结束时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="end_time" onClick="WdatePicker()" id="datemin" class="input-text Wdate" style="width:180px;height:1.8em">
            </div>
        </div>
        <div class="row cl">
