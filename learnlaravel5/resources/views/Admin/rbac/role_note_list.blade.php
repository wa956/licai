...
<div class="page-container">
	...
	<form action="role_note_add" method="post">
...
<!-- 		<thead>
		...
		<tbody>
				<tr>
					<th class="center" colspan="4" style="font-size:20px; color:#abcdef; padding-right:90%;">已拥有权限↓</th>
				</tr>
				<?php foreach ($role_note_list_true as $key => $value): ?>
				<tr>
					<td class="center"><input type="checkbox" name="box_id[]" value="<?= $value->id ?>" class="center" checked ></td>
					<td class="center"><?= $value->name ?></td>
					<td class="center"><?= $value->zh_name ?><br></td>
					<td class="center"><?= $value->created_time ?><br></td>
				</tr>
				<?php endforeach ?>
				<tr>
					<th class="center" colspan="4" style="font-size:20px; color:#abcdef; padding-right:90%;">未拥有权限↓</th>
				</tr>
				<?php foreach ($role_note_list_false as $key => $value): ?>
				<tr>
