  ...
  <div class="invest-list mrt30 clearfix">
    ...
    <div class="bd">
      <div class="invest-table clearfix">
        ...
        <div class="item">
          <ul>
            <li class="col-330 col-t"><a href="infor?id=<?=  $v->id?>" target="_blank"></a><a class="f18" href="infor?id=<?php echo $v->id?>" title="<?php echo $v->productName ?>" target="_blank"><?php echo $v->productName ?> </a></li>
