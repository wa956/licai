          ...
          <div class="inner">
            ...
            <?php if($userdata['username'] == ''){ ?>
              ...
              <?php }else{ ?>
                     ...
                     <?php } ?>
                  <span>剩余名额：<font color="#FF721F" id="sheng"><?= $sheng ?></font>/<font color="black" id="productAmount"><?= $data['number']?></font>人</span>
...
//                var zer =  fmoney(orderAmount,2);
              ...
              //上限名额
                var number=$('#productAmount').html();
                var productAmount = $('#productAmount').html();
                var sheng = $('#sheng').html();
               //去掉金额字符的，号以及。
              ...
              // alert(productAmount);
                var re = /^[0-9]*[0-9]$/i;       //校验是否为数字
                 if(re.test(orderAmount) && orderAmount%100===0) {
