...
<div class="flexslider">
  <ul class="slides">
    <li style="background-image: url(Home/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="#" target="_blank"></a></li>
    <li style="background-image: url(Home/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="#" target="_blank"></a></li>
    <li style="background-image: url(Home/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="#" target="_blank"></a></li>
    <li style="background-image: url(Home/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="# " target="_blank"></a></li>
    <li style="background-image: url(Home/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;" class=""><a href="#" target="_blank"></a></li>
    ...
    <div class="page-left fn-left">
      ...
      @foreach ($data as $key=>$val)
        <div class="mod-borrow mrt20">
          <div class="hd">
            <h2 class="pngbg"><i class="icon icon-yyyz"></i>{{$key}}</h2>
            <div class="fn-right f14 c-888">参与人次：<span class="c-555">{{count($val)}}次</span></div>
          </div>
          <div class="bd">
            ...
            <div class="borrow-list">
              <ul>
                  @foreach ($val as $v)
                      <li>
                          <div class="title"><a href="#" target="_blank"></a><a href="infor.html" class="f18" target="_blank"><span style="color: red">{{$v->username}}</span>投资了“{{$v->productName}}”{{$v->invest_money}}元</a></div>
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <tbody>
                              <tr>
                                  <td width="260">投资金额<span class="f24 c-333">{{$v->invest_money}}</span>元</td>
                                  <td width="165">年利率<span class="f24 c-orange relative">{{$v->rate}}%
                                          <!--公益标 20150724 lj-->
                                          <!--公益标 20150724 lj-->
                        </span></td>
                                  <td width="180" align="center">期限<span class="f24 c-333">{{$v->deadline}}</span>个月</td>
                                  <td><div class="circle">
                                  ...
                                  <td align="right"><a class="ui-btn btn-gray" href="#">进行中</a> </td>
                              </tr>
                              </tbody>
                          </table>
                      </li>
    ...
    <div class="page-right fn-right" style="top: 0px;">
            ...
            <div class="ui-tab-item active">
              <ul class="rank-list">
                  @foreach ($moneys as $key=>$val)
                      <li><span class="fl"><em class="n1">0{{$key+1}}</em>{{str_limit($val->username,2)}}******</span><span class="fr">￥{{$val->profit}}</span></li>
                  @endforeach
              </ul>
            </div>
            <div class="ui-tab-item">
              <ul class="rank-list">
                  @foreach ($invest as $key=>$val)
                      <li><span class="fl"><em class="n1">0{{$key+1}}</em>{{str_limit($val->username,2)}}******</span><span class="fr">￥{{$val->sum_money}}</span></li>
                  @endforeach
      ...
      <div class="mod mod-report ui-tab clearfix mrt20">
        ...
        <div class="bd">
          <div class="ui-tab-cont">
            <div class="ui-tab-item active">
              <div class="headlines"> <img src="Home/Home/images/news.jpg"> <a title="平台遭遇P2P滑稽抄袭" target="_blank" href="#">平台遭遇P2P滑稽抄袭</a><br>
      ...
      <div class="mrt20 mod"> <a href="#"><img src="Home/images/pic_home_js.jpg" width="300" height="80" alt="收益计算器" class="pic"></a></div>
    </div>
  </div>
</div>
      ...
      <div class="ui-tab-cont">
        <div class="ui-tab-item active">
          <div class="img-scroll">
            <div class="container">
              <ul>
                <li><img src="Home/Home/images/logo_sbcvc.png" width="152" height="52" alt="软银"></li>
                <li><img src="Home/Home/images/logo_abc.png" width="152" height="52" alt="农业银行"></li>
                <li><img src="Home/Home/images/logo_wdzj.png" width="152" height="52" alt="网贷之家"></li>
                <li><img src="Home/Home/images/logo_baidu.png" width="152" height="52" alt="百度"></li>
                <li><img src="Home/Home/images/logo_aqb.png" width="152" height="52" alt="安全宝"></li>
                <li><img src="Home/Home/images/logo_gds.png" width="152" height="52" alt="万国数据"></li>
              </ul>
            </div>
          </div>
        </div>
